...
@section('content')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h3>Manage MarkSheet</h3>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Report / MarkSheet</li>
            </ol>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div style="border: solid #adadad 2px; padding: 7px;">
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            <hr style="border: solid 1px; width: 100%; color: #DDD; margin-bottom: @px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table border="1" width="100%" cellpadding="9" cellspacing="2">
                                    @php
                                        $assign_student = App\Models\AssignStudent::where(
                                            'year_id',
                                            $allMarks['0']->year_id,
                                        )
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allMarks as $key => $mark)
                                            @php
                                                ...
                                                $total_subject = App\Models\StudentMarks::where(
                                                    'year_id',
                                                    $mark->year_id,
                                                )
                                        ...
                                        @endforeach
                                        <tr>
                                            <td colspan="3"><strong style="padding-left: 30px;float: left">Total
                                                    Marks: &nbsp;&nbsp;</strong></td>
                                            <td colspan="3" style="padding-left: 100px;">
                                                <strong style="float: left">{{ $total_marks }}</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                    </tbody>
