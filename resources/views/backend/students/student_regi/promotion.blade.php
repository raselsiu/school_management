    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
                ...
                <form method="POST" action="{{ route('promotionStore',$editData->student_id)}}" id="userForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm">Promote This Student</button>
