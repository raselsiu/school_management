    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <table width="100%">
                    <tr>
                        {{-- <td width="40%" class="text-center"><img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/uploads/no_img.png'))) }}"
                                style="width: 100px;height: 100px">
                        </td> --}}
                        <td class="text-center" width="100%">
                            <h3 style="margin: 0"><strong>Brahmanbaria Residential School & College</strong></h3>
                            <h4 style="margin-top:8px;margin-bottom: 8px;"><strong>Brahmanbaria Sadar, Brahmanbaria</strong></h4>
                            <h5 style="margin: 0"><strong>www.school.dcsdevs.com</strong></h5>
                        </td>
                        {{-- <td class="text-center">
                            <img
                                src="{{ asset('upload/student_image/' . $details['student']['image']) }}"
                                style="width: 100px;margin-left:100%">
                        </td> --}}
                    </tr>
                </table>
            </div>
            <div class="col-md-12 text-center">
                <h4 style="font-weight: bold; padding-top: -25px">Student Details Information</h4>
            </div>
            <div class="col-md-12">
