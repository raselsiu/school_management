...
@section('content')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h3>Manage Student Result</h3>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Report / Student / Result</li>
            </ol>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('getStudentResult') }}" method="GET" id="myForm" target="_blank">
                        <div class="form-row">
