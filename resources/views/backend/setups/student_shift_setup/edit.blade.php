        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title">Update Shift</h1>
                    <a href="{{ route('setupStudentShiftView') }}" class="float-right btn btn-sm btn-success"> <i
                            class="fa fa-list"></i>
                        &nbsp;View Shifts</a>
                </div>
                <form method="POST" action="{{ route('setupStudentShiftUpdate', $shift->id) }}" id="userForm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-Shift col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name"
                                    placeholder="Enter Class Name" value="{{ $shift->name }}">
                                @if ($errors->has('name'))
