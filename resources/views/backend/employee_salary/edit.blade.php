        ...
        <div class="col-md-12 col-lg-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('employeeRegiView') }}" class="float-right btn btn-sm btn-success">
                        <i class="fa fa-list"></i>
                        &nbsp;Employee Lists</a>
                </div>
                <form method="POST" action="{{ route('employeeRegiUpdate', $editData->id) }}" id="userForm"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" name="name" id="name"
                                    value="{{ $editData->name }}" placeholder="Enter Student Name">
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" name="fname" id="name"
                                    value="{{ $editData->fname }}" placeholder="Enter Student Name">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="name">Mother's Name<font style="color: red">*</font></label>
                                <input type="text" class="form-control form-control-sm" value="{{ $editData->mname }}"
                                    name="mname" id="name" placeholder="Enter Student Name">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="mobile">Mobile<font style="color: red">*</font></label>
                                <input type="text" class="form-control form-control-sm" value="{{ $editData->mobile }}"
                                    name="mobile" id="mobile" placeholder="Enter Student Name">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="address">Address<font style="color: red">*</font></label>
                                <input type="text" class="form-control form-control-sm" value="{{ $editData->address }}"
                                    name="address" id="address" placeholder="Enter Student Name">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control form-control-sm" name="religion" id="religion">
                                    <option value="">Select Option</option>
                                    <option value="islam" {{ $editData->relegion == 'islam' ? 'selected' : '' }}>Islam
                                    </option>
                                    <option value="hinduism" {{ $editData->relegion == 'hinduism' ? 'selected' : '' }}>
                                        Hinduism</option>
                                    <option value="christian" {{ $editData->relegion == 'christian' ? 'selected' : '' }}>
                                        Christian</option>
                                </select>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control form-control-sm" name="designation_id" id="designation_id">
                                    ...
                                    @foreach ($designaton as $desig)
                                        <option value="{{ $desig->id }}"
                                            {{ $desig->id == $editData->designation_id ? 'selected' : '' }}>
                                            {{ $desig->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            @if (!@$editData)
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="salary"
                                        value="{{ $editData->salary }}" id="salary" placeholder="Employee Salary">
                                </div>
                            ...
                            <div class="form-group col-md-3">
                                <img id="showImg"
                                    src="{{ $editData->image ? asset('upload/employee_image/' . $editData->image) : asset('uploads/no_img.png') }}"
                                    alt="Preview Image" height="80px" width="100px">
                            </div>
                        </div>
